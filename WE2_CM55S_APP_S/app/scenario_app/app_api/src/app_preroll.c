...
static app_auto_preroll_config_t g_preroll_config __attribute__ ((section(".preroll_data_arena"), aligned(4)))= {0};
static app_auto_preroll_status_t g_auto_preroll_status __attribute__ ((section(".preroll_data_arena"), aligned(4)))= {0};
    ...
    while(1)
    {
        ...
        if(g_frame_ready == 1)
        {
			...
			if( jpeg_enc_filesize_real != jpeg_enc_filesize)
			{
				...
				SCB_CleanDCache_by_Addr((volatile void *)g_preroll_config.jpeg_auto_fill_data, JPEG_AUTOFILL_SIZE/*100*/*sizeof(uint8_t));
			}
...
int8_t app_auto_preroll_reset_status(void)
{
    ...
    SCB_CleanDCache_by_Addr((volatile void *)g_preroll_config.jpeg_auto_fill_data, JPEG_AUTOFILL_SIZE*sizeof(uint8_t));
