...
#if (CISDP_INIT_TYPE == APP_INIT_TYPE_AOS)
...
#define SENCTRL_STREAM_TYPE			SENSORDPLIB_STREAM_NONEAOS_AUTOI2C_SOI
#endif
#endif
...
#else /*CIS_ENABLE_MIPI_INF*/
/*
 * DP SENCTRL CFG
 */
#define SENCTRL_SENSOR_TYPE					SENSORDPLIB_SENSOR_HM2170_SERIAL_MSB
#define SENCTRL_STREAM_TYPE					SENSORDPLIB_STREAM_HM11B1_LOWPOWER //SENSORDPLIB_STREAM_NONEAOS or SENSORDPLIB_STREAM_HM11B1_LOWPOWER or SENSORDPLIB_STREAM_NONEAOS_AUTOI2C_SOI
