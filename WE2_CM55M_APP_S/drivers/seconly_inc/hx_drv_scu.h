...
#ifndef BOOT_USED
/**
 * \brief	Set PA0 and PA1 Pull enable
 *
 * \param[in]	pa0	 PA0 Pull enable/disable
 * \param[in]	pa1	 PA1 Pull enable/disable
 * \return	SCU_ERROR_E.
 */
SCU_ERROR_E hx_drv_scu_set_pa01_pullenable(SCU_PA01_PULLENABLE_E pa0, SCU_PA01_PULLENABLE_E pa1);
