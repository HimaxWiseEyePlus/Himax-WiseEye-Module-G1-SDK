...
#define DW_IIC_CMD_SET_TXCB                               DEV_SET_IIC_SYSCMD(2)
#define DW_IIC_CMD_SET_RXCB                               DEV_SET_IIC_SYSCMD(3)
#define DW_IIC_CMD_SET_ERRCB                              DEV_SET_IIC_SYSCMD(4)
#define DW_IIC_CMD_SET_TXINT_BUF                          DEV_SET_IIC_SYSCMD(5)
#define DW_IIC_CMD_SET_RXINT_BUF                          DEV_SET_IIC_SYSCMD(6)
#define DW_IIC_CMD_SET_TXINT                              DEV_SET_IIC_SYSCMD(7)
#define DW_IIC_CMD_SET_RXINT                              DEV_SET_IIC_SYSCMD(8)
#define DW_IIC_CMD_FLUSH_TX                               DEV_SET_IIC_SYSCMD(12)
#define DW_IIC_CMD_FLUSH_RX                               DEV_SET_IIC_SYSCMD(13)
